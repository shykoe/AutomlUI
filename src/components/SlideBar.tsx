...
class SlideBar extends React.Component<SliderProps, SliderState> {
    ...
    mobileTabs = () => {
        ...
        return (
            ...
            <Menu className="menuModal" style={{ padding: '0 10px' }}>
                <Menu.Item key="overview"><Link to={`/${port}/oview`}>Overview</Link></Menu.Item>
                <Menu.Item key="detail"><Link to={`/${port}/detail`}>Trials detail</Link></Menu.Item>
            </Menu>
        );
    }
    ...
    desktopHTML = () => {
        const { version, menuVisible, port } = this.state;
        ...
        return (
            <Row className="nav">
                <Col span={8}>
                    ...
                    <Link to={`/${port}/oview`} activeClassName="high-light" className="common-tabs">
                        Overview
                    </Link>
                    </span>
                    <span>
                    <Link to={`/${port}/detail`} activeClassName="high-light" className="common-tabs">
                        Trials detail
                    </Link>
                    </span>
                </Col>
...
export default connect<any, any, any>((state,props)=>({port:state.PortReducer}) )(Form.create<FormComponentProps>()(SlideBar));
